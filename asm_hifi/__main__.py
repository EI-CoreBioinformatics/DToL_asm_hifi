...
def add_default_options(parser):
	...
	common_group.add_argument("--rerun", help="rerun a previously completed run",action="store_true")
	common_group.add_argument("sample_sheet", type=str)
...
def add_assembly_parser(subparsers):
	...
	#these files are useful if you want to rerun hifiasm with a different set of params. By default we delete them as they are large temporary files.
	assembly_parser.add_argument("--keepbin", help="Keep *.bin files generated by hifiasm",action="store_true")
